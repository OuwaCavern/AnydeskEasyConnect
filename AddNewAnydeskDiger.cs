...
{
    public partial class AddNewAnydeskDiger : Form
    {
        public AddNewAnydeskDiger()
        {
            InitializeComponent();
        }
        ...
        private void KaydetButonu_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string checkAnydeskNoCommand = $"SELECT SubeAnydeskNumarasi,SubeAdi FROM Diger WHERE SubeAnydeskNumarasi='{formattedSubeAnydeskNumarasi}'";
            ...
            string countCommand = "SELECT COUNT(*) FROM Diger";
            ...
            {
                string insertQuery = $"INSERT INTO Diger (Id,SubeAdi,SubeAnydeskNumarasi,SubeAnydeskParolasi,BilgisayarYetkisi) VALUES ({assignedId},'{subeAdi}','{subeAnydeskNumarasi}','{subeAnydeskParolasi}','{subeBilgisayarYetkisi}')";
