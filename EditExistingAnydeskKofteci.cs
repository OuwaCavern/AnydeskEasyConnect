...
{
    public partial class EditExistingAnydeskKofteci : Form
    {
        public EditExistingAnydeskKofteci()
        {
            InitializeComponent();
        }
        ...
        private void KaydetButonu_Click(object sender, EventArgs e)
        {
            ...
            if (duzenlenenSubeAdi.Count() >= 8)
            {
                ...
                if (eskiAnydeskNumarasi != duzenlenenAnydeskNumarasi)
                {
                    ...
                    string checkAnydeskNoCommand = $"SELECT SubeAnydeskNumarasi,SubeAdi FROM Kofteci WHERE SubeAnydeskNumarasi='{Algorithms.AnydeskNumarasiDuzenleyici(duzenlenenAnydeskNumarasi)}'";
                    ...
                    {
                        duzenlenenAnydeskNumarasi = Algorithms.AnydeskNumarasiDuzenleyici(duzenlenenAnydeskNumarasi);
                        string updateQuery = $"UPDATE Kofteci SET SubeAdi='{duzenlenenSubeAdi}',SubeAnydeskNumarasi='{duzenlenenAnydeskNumarasi}',SubeAnydeskParolasi='{duzenlenenAnydeskParolasi}',BilgisayarYetkisi='{duzenlenenBilgisayarYetkisi}' WHERE SubeAnydeskNumarasi='{Algorithms.AnydeskNumarasiDuzenleyici(eskiAnydeskNumarasi)}'";
