...
{
    public partial class AddNewAnydeskMaydonoz : Form
    {
        public AddNewAnydeskMaydonoz()
        {
            InitializeComponent();
        }
        ...
        private void KaydetButonu_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string checkAnydeskNoCommand = $"SELECT SubeAnydeskNumarasi,SubeAdi FROM Maydonoz WHERE SubeAnydeskNumarasi='{formattedSubeAnydeskNumarasi}'";
            ...
            string countCommand = "SELECT COUNT(*) FROM Maydonoz";
            ...
            {
                string insertQuery = $"INSERT INTO Maydonoz (Id,SubeAdi,SubeAnydeskNumarasi,SubeAnydeskParolasi,BilgisayarYetkisi) VALUES ({assignedId},'{subeAdi}','{subeAnydeskNumarasi}','{subeAnydeskParolasi}','{subeBilgisayarYetkisi}')";
