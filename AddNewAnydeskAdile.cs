...
{
    public partial class AddNewAnydeskAdile : Form
    {
        public AddNewAnydeskAdile()
        {
            InitializeComponent();
        }
        ...
        private void KaydetButonu_Click(object sender, EventArgs e)
        {
            ...
            string checkAnydeskNoCommand = $"SELECT SubeAnydeskNumarasi,SubeAdi FROM Adile WHERE SubeAnydeskNumarasi='{subeAnydeskNumarasi}'";
            ...
            string countCommand = "SELECT COUNT(*) FROM Adile";
            ...
            {
                string insertQuery = $"INSERT INTO Adile (Id,SubeAdi,SubeAnydeskNumarasi,SubeAnydeskParolasi,BilgisayarYetkisi) VALUES ({assignedId},'{subeAdi}','{subeAnydeskNumarasi}','{subeAnydeskParolasi}','{subeBilgisayarYetkisi}')";
