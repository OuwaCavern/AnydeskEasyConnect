...
{
    public partial class AddNewAnydeskHey : Form
    {
        public AddNewAnydeskHey()
        {
            InitializeComponent();
        }
        ...
        private void KaydetButonu_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string checkAnydeskNoCommand = $"SELECT SubeAnydeskNumarasi,SubeAdi FROM Hey WHERE SubeAnydeskNumarasi='{formattedSubeAnydeskNumarasi}'";
            ...
            string countCommand = "SELECT COUNT(*) FROM Hey";
            ...
            {
                string insertQuery = $"INSERT INTO Hey (Id,SubeAdi,SubeAnydeskNumarasi,SubeAnydeskParolasi,BilgisayarYetkisi) VALUES ({assignedId},'{subeAdi}','{subeAnydeskNumarasi}','{subeAnydeskParolasi}','{subeBilgisayarYetkisi}')";
