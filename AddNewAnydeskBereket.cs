...
{
    public partial class AddNewAnydeskBereket : Form
    {
        public AddNewAnydeskBereket()
        {
            InitializeComponent();
        }
        ...
        private void KaydetButonu_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string checkAnydeskNoCommand = $"SELECT SubeAnydeskNumarasi,SubeAdi FROM Bereket WHERE SubeAnydeskNumarasi='{formattedSubeAnydeskNumarasi}'";
            ...
            string countCommand = "SELECT COUNT(*) FROM Bereket";
            ...
            {
                string insertQuery = $"INSERT INTO Bereket (Id,SubeAdi,SubeAnydeskNumarasi,SubeAnydeskParolasi,BilgisayarYetkisi) VALUES ({assignedId},'{subeAdi}','{subeAnydeskNumarasi}','{subeAnydeskParolasi}','{subeBilgisayarYetkisi}')";
