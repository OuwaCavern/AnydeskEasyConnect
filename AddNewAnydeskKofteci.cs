...
{
    public partial class AddNewAnydeskKofteci : Form
    {
        public AddNewAnydeskKofteci()
        {
            InitializeComponent();
        }
        ...
        private void KaydetButonu_Click(object sender, EventArgs e)
        {
            ...
            string checkAnydeskNoCommand = $"SELECT SubeAnydeskNumarasi,SubeAdi FROM Kofteci WHERE SubeAnydeskNumarasi='{subeAnydeskNumarasi}'";
            ...
            string countCommand = "SELECT COUNT(*) FROM Kofteci";
