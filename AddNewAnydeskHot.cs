...
{
    public partial class AddNewAnydeskHot : Form
    {
        public AddNewAnydeskHot()
        {
            InitializeComponent();
        }
        ...
        private void KaydetButonu_Click(object sender, EventArgs e)
        {
            ...
            string checkAnydeskNoCommand = $"SELECT SubeAnydeskNumarasi,SubeAdi FROM Hot WHERE SubeAnydeskNumarasi='{formattedSubeAnydeskNumarasi}'";
            ...
            string countCommand = "SELECT COUNT(*) FROM Hot";
            ...
            {
                string insertQuery = $"INSERT INTO Hot (Id,SubeAdi,SubeAnydeskNumarasi,SubeAnydeskParolasi,BilgisayarYetkisi) VALUES ({assignedId},'{subeAdi}','{subeAnydeskNumarasi}','{subeAnydeskParolasi}','{subeBilgisayarYetkisi}')";
